...
export class RoleService {
    ...
    public async createRole(
        ...
        try {
            ...
            const response = await this.roleRepository.findOneBy({
                value: dto.value,
            });
    ...
    ): Promise<ResponseRoleDto<IUserRole>> {
        try {
    ...
    public async getRolesForUser(
        ...
        try {
            const relations = await this.userRoleRepository.findBy({
                userId: userId,
            });
