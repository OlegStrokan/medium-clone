export enum SubscriptionLogsEnum {
    ...
    SUBSCRIPTION_ASSIGNMENT_INITIATED = 'Subscription assignment initiated',
    ...
    SUBSCRIPTION_DELETE_INITIATED = 'Subscription deleting initiated',
    SUBSCRIPTION_DELETE_SUCCESS = 'Subscription deleting successful',
    SUBSCRIPTION_DELETE_ERROR = 'Subscription deleting error',
